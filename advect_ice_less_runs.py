...
def run_experiment(start_date, simdays = 35, custom_kernel = "AdvectionRK4_prob", outputdir = '/home/students/6252699/thesis/parcels2/output/', year = 2014):
    ...
    output_name = outputdir   + "04-08_npart_{}_start_{}_simdays_{}_kernel_".format(npart, start_date,  simdays) + custom_kernel
    ...
    for kernel in kernels:
        for month in [2, 8]:
            for year in [2014, 2015, 2016]:
                ...
                if (kernel=="AdvectionRK4_prob" and month==2 and (year==2014 or year==2015)):
                    continue
                else:
