...
uo_season = ds_glorys.isel(depth=0).uo.groupby('time.season').mean('time')
vo_season = ds_glorys.isel(depth=0).vo.groupby('time.season').mean('time')
uo_month  = ds_glorys.isel(depth=0).uo.groupby('time.month').mean('time')
vo_month  = ds_glorys.isel(depth=0).vo.groupby('time.month').mean('time')

usi_season = ds_glorys.usi.groupby('time.season').mean('time')
vsi_season = ds_glorys.vsi.groupby('time.season').mean('time')
usi_month  = ds_glorys.usi.groupby('time.month').mean('time')
vsi_month  = ds_glorys.vsi.groupby('time.month').mean('time')
...
uo_season.to_netcdf(path=data_dir + "uo_seasonal_mean_2001-2016")
vo_season.to_netcdf(path=data_dir + "vo_seasonal_mean_2001-2016")

print("Exported seasonal means...")

uo_month.to_netcdf(path=data_dir + "uo_monthly_mean_2001-2016")
vo_month.to_netcdf(path=data_dir + "vo_monthly_mean_2001-2016")
print("Exported monthly means...")


print("\Ice velocities")

usi_season.to_netcdf(path=data_dir + "usi_seasonal_mean_2001-2016")
vsi_season.to_netcdf(path=data_dir + "vsi_seasonal_mean_2001-2016")

print("Exported seasonal means...")

usi_month.to_netcdf(path=data_dir + "usi_monthly_mean_2001-2016")
vsi_month.to_netcdf(path=data_dir + "vsi_monthly_mean_2001-2016")
print("Exported monthly means...")
